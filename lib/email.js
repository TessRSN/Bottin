...
async function sendAcceptanceEmail(to, name, type) {
  ...
  const inner = `
    ...
    <p style="margin-top:1.5rem">Pour en savoir plus sur le RSN et nos activités, visitez notre site web : <a href="${RSN_WEBSITE_FR}">${RSN_WEBSITE_FR}</a></p>
    ...
    <p style="margin-top:1.5rem">To learn more about the RSN and our activities, visit our website: <a href="${RSN_WEBSITE_EN}">${RSN_WEBSITE_EN}</a></p>
