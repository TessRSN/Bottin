...
async function sendProfileCampaign(to, name, magicUrl) {
  ...
  <div style="background:#ebf8ff;border-radius:0.5rem;padding:1rem 1.25rem;margin-bottom:1rem">
    ...
    <img src="${baseUrl}/img/campagne-connexions.gif" alt="La vue Connexions en mouvement : zoom sur la carte, fiche d'une personne et mots-clés communs avec un profil proche" width="400" height="389" style="display:block;width:100%;max-width:400px;height:auto;margin:0.75rem auto 0.25rem auto;border-radius:0.5rem;border:1px solid #cbd5e0">
  </div>
  ...
  <div style="background:#ebf8ff;border-radius:0.5rem;padding:1rem 1.25rem;margin-bottom:1rem">
    ...
    <img src="${baseUrl}/img/campagne-connexions.gif" alt="The Connections view in motion: zooming on the map, a member's card and the keywords shared with a close profile" width="400" height="389" style="display:block;width:100%;max-width:400px;height:auto;margin:0.75rem auto 0.25rem auto;border-radius:0.5rem;border:1px solid #cbd5e0">
  </div>
